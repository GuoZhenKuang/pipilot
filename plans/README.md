...
| [004](004-simplify-tree-and-incremental-sync.md) | Simplify tree handling and implement incremental synchronization | P1 | L | 003 | BLOCKED (`get_entries` returns append-order entries from all branches, but RPC docs do not define reconstruction of the active message timeline across compaction/custom entries) |
