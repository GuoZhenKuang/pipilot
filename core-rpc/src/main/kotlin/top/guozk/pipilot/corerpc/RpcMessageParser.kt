package top.guozk.pipilot.corerpc
...
class RpcMessageParser(
    ...
    fun parse(line: String): RpcIncomingMessage {
        ...
        return when (type) {
            ...
            -> json.decodeFromJsonElement<AutoCompactionStartEvent>(jsonObject)
            "compaction_end",
            "auto_compaction_end",
            -> json.decodeFromJsonElement<AutoCompactionEndEvent>(jsonObject)
