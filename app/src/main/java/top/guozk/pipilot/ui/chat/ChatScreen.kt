...
import top.guozk.pipilot.chat.ChatUiState
import top.guozk.pipilot.chat.ChatViewModel
import top.guozk.pipilot.chat.ChatViewModelFactory
...
import top.guozk.pipilot.perf.StreamingFrameMetrics
...
private fun ChatHeader(
    ...
    connectionState: top.guozk.pipilot.corenet.ConnectionState,
                    ...
                    Text(
                        ...
                        color =
                            when (connectionState) {
                                top.guozk.pipilot.corenet.ConnectionState.CONNECTED ->
                                    MaterialTheme.colorScheme.primary
                                top.guozk.pipilot.corenet.ConnectionState.CONNECTING,
                                top.guozk.pipilot.corenet.ConnectionState.RECONNECTING,
...
private fun formatConnectionSummary(
    ...
    val statusLabel =
        when (connectionState) {
            top.guozk.pipilot.corenet.ConnectionState.CONNECTED -> "已连接"
            top.guozk.pipilot.corenet.ConnectionState.CONNECTING -> "连接中"
            top.guozk.pipilot.corenet.ConnectionState.RECONNECTING -> "重新连接中"
            top.guozk.pipilot.corenet.ConnectionState.DISCONNECTED -> "离线"
        }
